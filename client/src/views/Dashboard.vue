...
export default {
  ...
  setup() {
    ...
    const categoryData = computed(() => {
      ...
      // Use a single brand-accent (orange) color for all category bars
      const singleColor = 'var(--accent)' // Brand accent (orange)
...
.task-add-btn {
  ...
  background: linear-gradient(135deg, var(--chart-from) 0%, var(--chart-to) 100%);
  color: var(--accent-contrast);
  border: none;
  border-radius: 8px;
  font-weight: 600;
